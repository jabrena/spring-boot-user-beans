...
class ActuatorBeanVsApplicationContextTests {
    ...
    void shouldBeEmpty() {
        ...
        var list1 = getBeansFromActuator().stream()
                .map(String::toLowerCase).toList();
        var list2 = getBeansFromApplicationContext().stream()
                .map(String::toLowerCase).toList();;
    ...
    private List<String> getBeansFromActuator() {
        ...
        Map<String, BeansEndpoint.ContextBeansDescriptor> context = beansEndpoint.beans().getContexts();
